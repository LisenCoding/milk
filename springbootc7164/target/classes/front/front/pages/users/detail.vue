		...
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0px 0 132rpx","position":"relative","background":"#fff","height":"auto"}'>
            <view :style='{"padding":"0px 24rpx 24rpx","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"12rpx 20rpx 12rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"0px","flexWrap":"wrap","borderWidth":"0px","background":"url(http://codegen.caihongy.cn/20230303/adcda4c7311148a1913eb708c6fdebf0.png) no-repeat left top,url(http://codegen.caihongy.cn/20230303/41517a62f11849869c71aed71b75484e.png) no-repeat right bottom,#fffcf3","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					...
					<view  class="text" :style='{"width":"100%","padding":"12rpx 20rpx 20rpx 0","margin":"0px 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.username}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"12rpx 20rpx 12rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"0px","flexWrap":"wrap","borderWidth":"0px","background":"url(http://codegen.caihongy.cn/20230303/adcda4c7311148a1913eb708c6fdebf0.png) no-repeat left top,url(http://codegen.caihongy.cn/20230303/41517a62f11849869c71aed71b75484e.png) no-repeat right bottom,#fffcf3","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","borderColor":"#ebc7ab","color":"#844819","textAlign":"left","borderWidth":"0 0 2rpx","width":"100%","lineHeight":"68rpx","fontSize":"32rpx","borderStyle":"dashed","fontWeight":"500"}'>密码：</view>
					<view  class="text" :style='{"width":"100%","padding":"12rpx 20rpx 20rpx 0","margin":"0px 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.password}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"inset 0px 0px 0px 0px #f9edd9","padding":"12rpx 20rpx 12rpx","margin":"20rpx 0 20rpx 0","borderColor":"#e9be70","borderRadius":"0px","flexWrap":"wrap","borderWidth":"0px","background":"url(http://codegen.caihongy.cn/20230303/adcda4c7311148a1913eb708c6fdebf0.png) no-repeat left top,url(http://codegen.caihongy.cn/20230303/41517a62f11849869c71aed71b75484e.png) no-repeat right bottom,#fffcf3","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","borderColor":"#ebc7ab","color":"#844819","textAlign":"left","borderWidth":"0 0 2rpx","width":"100%","lineHeight":"68rpx","fontSize":"32rpx","borderStyle":"dashed","fontWeight":"500"}'>角色：</view>
					<view  class="text" :style='{"width":"100%","padding":"12rpx 20rpx 20rpx 0","margin":"0px 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.role}}</view>
				</view>
